...
return new HoverTip(
            ...
            yield
return HoverTipFactory.FromCard<MegaCrit.Sts2.Core.Models.Cards.Void>();
        }
    }
...
base.CombatState.HittableEnemies, (decimal)base.Amount, ValueProp.Move,
base.Owner);
            }
...
await PlayerCmd.GainEnergy(1, player);
            ...
            CardModel voidCard =
base.CombatState.CreateCard<MegaCrit.Sts2.Core.Models.Cards.Void>(player);
